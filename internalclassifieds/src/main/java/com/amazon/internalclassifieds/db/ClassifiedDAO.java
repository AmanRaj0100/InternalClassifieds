...
public class ClassifiedDAO implements DAO<Classifieds> {
	...
	public int insert(Classifieds Object) {
		String sql = "INSERT INTO Classifieds (productName, headline, brand, description, condition, userID, price, pictures, status) Values ('"+Object.productName+"','"+Object.headline+"','"+Object.brand+"','"+Object.description+"','"+Object.condition+"',"+Object.userID+","+Object.price+",'"+Object.pictures+"',"+Object.status+")";
	...
	public int update(Classifieds Object) {
		String sql = "UPDATE Classifieds SET productName = '"+Object.productName+"', headline = '"+Object.headline+"', brand = '"+Object.brand+"', description = '"+Object.description+"', condition = '"+Object.condition+"', price = "+Object.price+", pictures = '"+Object.pictures+"', status = "+Object.status+" WHERE classifiedID = "+Object.classifiedID;
		return db.executeSQL(sql);
	}
	...
	public List<Classifieds> retrieve() {
		...
		try {
			while(set.next()) {
				...
				// Read the row from ResultSet and put the data into Classified Object
