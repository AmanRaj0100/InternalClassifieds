...
public class OrderManagement {
	...
	ClassifiedManagement manageClassifieds = ClassifiedManagement.getInstance();
	
	private static OrderManagement manageOrders = new OrderManagement();
